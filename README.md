...
After installing the parallel version of MUMPS, to install MESTI.jl simply open Julia REPL and set the Julia environment variable <code>MUMPS_PREFIX</code>to the path to your own MUMPS libraries. For example, in Julia REPL, we can type 
...
Please remember to set your own path for <code>ENV["MUMPS_PREFIX"]</code>
